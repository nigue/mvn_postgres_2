...
public class TestMybatis {
    ...
    public void updateUsuarioTest() {
        ...
        Usuario usuario = new Usuario();
        usuario.setRut(44444444);
        usuario.setPassword("user_4");
        usuario.setNombre("nombre4");
        usuarioService.insertUsuario(usuario);
        usuario = usuarioService.getUsuario(44444444);
        Integer newP = new Integer(0);
        newP = (int) (Math.random() * 9999);
        usuario.setNombre(newP.toString());
        usuarioService.updateUsuario(usuario);
        Usuario usuarioDelta = new Usuario();
        usuarioDelta = usuarioService.getUsuario(44444444);
        Assert.assertNotEquals(usuarioDelta.getNombre(), "user_4");
    }
